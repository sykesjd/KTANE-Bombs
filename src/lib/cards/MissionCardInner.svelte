<script lang="ts">
	...
	const color = `linear-gradient(${orBlank(solveTypes.normalSolve, 'hsl(210, 100%, 65%)')} 25%, ${orBlank(
		solveTypes.efmSolve,
		'hsl(300, 100%, 75%)'
	)} 25.01% 50%, ${orBlank(mission.tpSolve, '#9146ff')} 50.01% 75%, ${orBlank(
		solveTypes.soloSolve,
		'#00ffff'
	)} 75.01%)`;
